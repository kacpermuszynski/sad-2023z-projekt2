...
accidents_by_months_reg_days <- accidents_per_month / days_in_months

test_result <- chisq.test(accidents_by_months_reg_days)
...
days_in_months <- c(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
deaths_by_months_reg_days <- deaths_per_month / days_in_months

test_result <- chisq.test(deaths_by_months_reg_days)
